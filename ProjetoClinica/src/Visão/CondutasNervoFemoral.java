 ...
 * @author vinic
 */
public class CondutasNervoFemoral extends javax.swing.JFrame {

    /**
     * Creates new form CondutasNervoFemoral
     */
    public CondutasNervoFemoral() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel20.setText("PROPOSTAS - NERVO FEMORAL");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CondutasNervoFemoral.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CondutasNervoFemoral().setVisible(true);
            }
        });
    }
