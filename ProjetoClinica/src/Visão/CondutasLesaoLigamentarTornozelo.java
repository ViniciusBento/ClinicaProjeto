 ...
 * @author vinic
 */
public class CondutasLesaoLigamentarTornozelo extends javax.swing.JFrame {

    /**
     * Creates new form CondutasLesaoLigamentarTornozelo
     */
    public CondutasLesaoLigamentarTornozelo() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CondutasLesaoLigamentarTornozelo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CondutasLesaoLigamentarTornozelo().setVisible(true);
            }
        });
    }
