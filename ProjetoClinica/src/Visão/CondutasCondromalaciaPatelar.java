 ...
 * @author vinic
 */
public class CondutasCondromalaciaPatelar extends javax.swing.JFrame {

    /**
     * Creates new form CondutasCondromalaciaPatelar
     */
    public CondutasCondromalaciaPatelar() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel20.setText("PROPOSTAS - CONDROMALACIA PATELAR");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CondutasCondromalaciaPatelar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CondutasCondromalaciaPatelar().setVisible(true);
            }
        });
    }
