 ...
 * @author vinic
 */
public class CondutasInstabilidadeGlenoumeral extends javax.swing.JFrame {

    /**
     * Creates new form CondutasInstabilidadeGlenoumeral
     */
    public CondutasInstabilidadeGlenoumeral() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CondutasInstabilidadeGlenoumeral.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CondutasInstabilidadeGlenoumeral().setVisible(true);
            }
        });
    }
