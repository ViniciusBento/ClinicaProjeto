 ...
 * @author vinic
 */
public class CondutasArtroplastiaTornozelo extends javax.swing.JFrame {

    /**
     * Creates new form CondutasArtroplastiaTornozelo
     */
    public CondutasArtroplastiaTornozelo() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel20.setText("PROPOSTAS - ARTROPLASTIA DO TORNOZELO");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CondutasArtroplastiaTornozelo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CondutasArtroplastiaTornozelo().setVisible(true);
            }
        });
    }
