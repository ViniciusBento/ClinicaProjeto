 ...
 * @author vinic
 */
public class CondutasRadicular extends javax.swing.JFrame {

    /**
     * Creates new form CondutasRadicular
     */
    public CondutasRadicular() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel20.setText("PROPOSTAS - RADICULAR");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CondutasRadicular.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CondutasRadicular().setVisible(true);
            }
        });
    }
