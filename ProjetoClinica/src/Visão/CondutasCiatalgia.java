 ...
 * @author vinic
 */
public class CondutasCiatalgia extends javax.swing.JFrame {

    /**
     * Creates new form CondutasCiatalgia
     */
    public CondutasCiatalgia() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel20.setText("PROPOSTAS - CIATALGIA");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CondutasCiatalgia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CondutasCiatalgia().setVisible(true);
            }
        });
    }
