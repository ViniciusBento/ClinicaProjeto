 ...
 * @author vinic
 */
public class CondutasAlteraçaodeCoordenaçaodeMovimento extends javax.swing.JFrame {

    /**
     * Creates new form CondutasAlteraçaodeCoordenaçaodeMovimento
     */
    public CondutasAlteraçaodeCoordenaçaodeMovimento() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel20.setText("PROPOSTAS - ALTERAÇÃO DE COORDENAÇÃO DE MOVIMENTO");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CondutasAlteraçaodeCoordenaçaodeMovimento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CondutasAlteraçaodeCoordenaçaodeMovimento().setVisible(true);
            }
        });
    }
