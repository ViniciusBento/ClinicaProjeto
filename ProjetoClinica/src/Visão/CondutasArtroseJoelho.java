 ...
 * @author vinic
 */
public class CondutasArtroseJoelho extends javax.swing.JFrame {

    /**
     * Creates new form CondutasArtroseJoelho
     */
    public CondutasArtroseJoelho() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel20.setText("PROPOSTAS - ARTROSE DO JOELHO");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CondutasArtroseJoelho.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CondutasArtroseJoelho().setVisible(true);
            }
        });
    }
