 ...
 * @author vinic
 */
public class CondutasIntercostal extends javax.swing.JFrame {

    /**
     * Creates new form CondutasIntercostal
     */
    public CondutasIntercostal() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel20.setText("PROPOSTAS - INTERCOSTAIS");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CondutasIntercostal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CondutasIntercostal().setVisible(true);
            }
        });
    }
