 ...
 * @author vinic
 */
public class CondutasNervoFibular extends javax.swing.JFrame {

    /** Creates new form CondutasNervoFibular */
    public CondutasNervoFibular() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel20.setText("PROPOSTAS - NERVO FIBULAR");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CondutasNervoFibular.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CondutasNervoFibular().setVisible(true);
            }
        });
    }
