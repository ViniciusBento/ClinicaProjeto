 ...
 * @author vinic
 */
public class CondutasEntorsedeTornozelo extends javax.swing.JFrame {

    /**
     * Creates new form CondutasEntorsedeTornozelo
     */
    public CondutasEntorsedeTornozelo() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel20.setText("PROPOSTAS - ENTORSE DE TORNOZELO");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CondutasEntorsedeTornozelo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CondutasEntorsedeTornozelo().setVisible(true);
            }
        });
    }
