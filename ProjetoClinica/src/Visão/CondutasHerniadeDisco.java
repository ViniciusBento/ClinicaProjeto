 ...
 * @author vinic
 */
public class CondutasHerniadeDisco extends javax.swing.JFrame {

    /** Creates new form CondutasHerniadeDisco */
    public CondutasHerniadeDisco() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel20.setText("PROPOSTAS - HÉRNIA DE DISCO");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CondutasHerniadeDisco.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CondutasHerniadeDisco().setVisible(true);
            }
        });
    }
