 ...
 * @author vinic
 */
public class CondutasRetraçoesMusculares extends javax.swing.JFrame {

    /**
     * Creates new form CondutasRetraçoesMusculares
     */
    public CondutasRetraçoesMusculares() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel20.setText("PROPOSTAS - RETRAÇÕES MUSCULARES");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CondutasRetraçoesMusculares.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CondutasRetraçoesMusculares().setVisible(true);
            }
        });
    }
