 ...
 * @author vinic
 */
public class CondutasInstabildadePatelar extends javax.swing.JFrame {

    /**
     * Creates new form CondutasInstabildadePatelar
     */
    public CondutasInstabildadePatelar() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel20.setText("PROPOSTAS - INSTABILIDADE PATELAR");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CondutasInstabildadePatelar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CondutasInstabildadePatelar().setVisible(true);
            }
        });
    }
