 ...
 * @author vinic
 */
public class COndutasArtroseQuadril extends javax.swing.JFrame {

    /**
     * Creates new form COndutasArtroseQuadril
     */
    public COndutasArtroseQuadril() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel20.setText("CONDUTAS ARTROSE DO QUADRIL");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(COndutasArtroseQuadril.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new COndutasArtroseQuadril().setVisible(true);
            }
        });
    }
