 ...
 * @author vinic
 */
public class CondutasPlacaPlantar extends javax.swing.JFrame {

    /**
     * Creates new form CondutasPlacaPlantar
     */
    public CondutasPlacaPlantar() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel20.setText("PROPOSTAS - PLACA PLANTAR");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CondutasPlacaPlantar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CondutasPlacaPlantar().setVisible(true);
            }
        });
    }
