 ...
 * @author vinic
 */
public class CondutasDorPosterior extends javax.swing.JFrame {

    /**
     * Creates new form CondutasDorPosterior
     */
    public CondutasDorPosterior() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel20.setText("PROPOSTAS - DOR POSTERIOR DE JOELHO");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CondutasDorPosterior.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CondutasDorPosterior().setVisible(true);
            }
        });
    }
