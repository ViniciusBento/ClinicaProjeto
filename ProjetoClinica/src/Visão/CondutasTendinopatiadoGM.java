 ...
 * @author vinic
 */
public class CondutasTendinopatiadoGM extends javax.swing.JFrame {

    /** Creates new form CondutasTendinopatiadoGM */
    public CondutasTendinopatiadoGM() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel20.setText("PROPOSTAS - TENDINOPATIA DO GLÚTEO MEDIO");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CondutasTendinopatiadoGM.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CondutasTendinopatiadoGM().setVisible(true);
            }
        });
    }
